...
Route::patch('rates/{rate}/toggle-status', [RateController::class, 'toggleStatus'])
    ->name('rates.toggle-status');

// API-like routes for getting rates
Route::get('/rates/current', [RateController::class, 'getCurrentRates']);
Route::get('/rates/{code}', [RateController::class, 'getRateByCode']); 
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    ////Routes for Daily Rates
Route::get('/daily-rates', [UnitController::class, 'dailyrates'])->name('unit.dailyrates');


Route::get('/createrate','UnitController@createrate');
