...
$(document).on('change', 'input#single_dpp', function(e) {
    ...
    // Multiplication operation: purchase_exc_tax * (1 + tax_rate/100)
    ...
    // Multiplication operation: purchase_exc_tax * (1 + profit_percent/100)
   //  var selling_price = purchase_exc_tax * (1 + ((1-profit_percent / 100)));
    ...
    // Multiplication operation: selling_price * (1 + tax_rate/100)
...
$(document).on('change', 'input#single_dpp_inc_tax', function(e) {
    ...
    // Division operation: purchase_inc_tax / (1 + tax_rate/100)
...
$(document).on('change', 'input#single_dsp', function(e) {
    ...
    if (purchase_exc_tax == 0) {
        ...
        // Division and multiplication operations: ((selling_price - purchase_exc_tax) / purchase_exc_tax) * 100
        profit_percent = ((selling_price - purchase_exc_tax) / purchase_exc_tax) * 100;
    }
...
$(document).on('change', 'input#single_dsp_inc_tax', function(e) {
    ...
    // Division operation: selling_price_inc_tax / (1 + tax_rate/100)
