        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-primary active">
              ...
              <form class="form" id="details_form" method="post" 
                    ...
                    <code>        @if(isset($module_display_name) && !empty($module_display_name))
            <code>{{$module_display_name}} Module</code>
        @else
            <code>Module</code>
        @endif Module</code>
                    
                    
                    <br/><small class="text-danger"> Make sure to provide correct licensing information</small></h2>
                    <hr/>
