...
<div class="row" style="color: #000000 !important;">
		...
		@if(empty($receipt_details->letter_head))
			@if(!empty($receipt_details->logo))
				<img style="max-height: 150px; width: 100%;" src="{{$receipt_details->logo}}" class="img img-responsive center-block">
			@endif
<hr/>
        ...
        <div class="table-responsive">
          	<table class="table table-slim">
				<tbody>
					...
					<tr>
						<th>
							{!! $receipt_details->total_label !!} USD
						</th>
						<td class="text-right">
						...
						<tr>
						<th>
							{!! $receipt_details->total_label !!} Exchange Rate
						</th>
						<td class="text-right">
						  {{ $getdailyuodaterate->dailyrate ?? 'N/A' }}
					...
					<tr>
    <th>
        {!! $receipt_details->total_label !!} SSP Equivalence
    </th>
    <td class="text-right">
        @php
            $ssp_total = isset($getdailyuodaterate->dailyrate) && isset($receipt_details->total)
                ? (float)$receipt_details->total * (float)$getdailyuodaterate->dailyrate
                : 'N/A';
        @endphp
        {{ is_numeric($ssp_total) ? number_format($ssp_total, 2) : $ssp_total }} SSP
    </td>
</tr>
