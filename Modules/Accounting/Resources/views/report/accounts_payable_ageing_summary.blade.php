...
@section('title')
    {{ trans_choice('accounting::report.accounts_payable_ageing_summary', 1) }}
@endsection
...
@section('content')
    ...
    <section class="content no-print" id="vue-app">
        <div class="row">
            ...
            @component('accounting::components.box')
                @slot('body')
                    <h3 class="text-center">{{ trans_choice('accounting::report.accounts_payable_ageing_summary', 1) }}</h3>
